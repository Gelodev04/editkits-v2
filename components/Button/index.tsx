...
function ButtonStyle(variant: string, filled?: boolean, disabled?: boolean, width?: number, border?: boolean, bold?: boolean, className?: string) {
  if (variant === "primary") {
    return `${bold ? "font-black text-[#2c2c2c]": "font-semibold text-neutral-500"}  hover:scale-105 transition-transform duration-300 hover:text-[#2c2c2c] text-sm flex gap-4 justify-center`
...
export default function Button(props: ButtonProps) {
  return (
    <button
      ...
      className={ButtonStyle(props.variant, props.filled, props.disabled, props.width, props.border, props.bold, props.className)}
