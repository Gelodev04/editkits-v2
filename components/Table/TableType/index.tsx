  ...
  return (
    <div className="py-8 px-2 flex flex-col gap-2 bg-white w-[228px] min-h-full rounded rounded-lg">
      <button
        ...
        className={`flex justify-start pl-4 items-center py-4 max-h-[48px] rounded rounded-lg gap-4 w-[192px] mx-auto ${active === "Job status" ? 'bg-[#17abdb]' : ""}`}
      >
      ...
      <button
        ...
        className={`flex justify-start pl-4 items-center py-4 max-h-[48px] rounded rounded-lg gap-4 w-[192px] mx-auto ${active === "Uploaded files" ? 'bg-[#17abdb]' : ""}`}
      >
