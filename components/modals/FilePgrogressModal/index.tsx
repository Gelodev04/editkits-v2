              ...
              <div
                ...
                {(props.data?.status === "PENDING" || props.data?.status === "IN_PROGRESS") && (
                  <>
                    ...
                    <p
                      className="font-lato font-bold text-sm leading-[21px] text-center text-[#273266]">Processing... {props.data?.progress}%</p>
                    <p
                ...
                {props.data?.status === "COMPLETED" && (
                  <>
                    ...
                    <div className="flex justify-center items-center gap-[6px] pb-[59px]">
                      <p className="font-lato font-normal text-sm leading-[19.6px] text-[#4f4f4f]">#{props.data?.id.slice(0,5)}</p>
                      <Image
                        width={24}
                        src={Copy}
                        alt="Play Icon"
                ...
                {(props.data?.status === "FAILED" || props.data?.status === "CANCELLED") && (
                  <>
                    ...
                    <p
                      ...
                      An error occurred while processing your job. Please try again, and if the issue persists, contact support for assistance.</p>
                  </>
                )}
