...
export default function Hero({setWaitlistModal}) {
  return (
    <div className="bg-[url(../public/images/hero_bg.png)] max-w-[1400px] mx-auto bg-center bg-cover px-8 lg:px-0">
      <div
        className="pb-[159.5px] max-w-[1187px] sm:px-5 xl:px-0 flex flex-col gap-24 lg:gap-0 lg:grid grid-cols-12 mx-auto sm:items-center xl:items-end">
        <div className="w-full lg:col-span-6 pt-[134.5px]">
          <h1 className="font-montserrat font-extrabold text-[40px] leading-[56px] tracking-[0.2px] text-[#2c2c2c] dark:text-white">The
            Ultimate</h1>
          <h1
            className="font-montserrat font-extrabold text-[40px] leading-[56px] tracking-[0.2px] text-[#2c2c2c] dark:text-white">Online
