...
export default function JobStatus() {
  ...
  return (
    <div className="flex justify-center">
      ...
      <div
        className={`${mainContentMargin} min-h-screen mt-10 transition-all duration-300 ease-in-out overflow-hidden bg-white dark:bg-white/[0.03] rounded-xl sm:w-[1280px] sm:mx-10 lg:mx-0 lg:w-[1536px] p-6`}>
        <div
