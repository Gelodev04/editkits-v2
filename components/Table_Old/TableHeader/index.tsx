    ...
    <div className="flex justify-between py-4">
      <div className="flex gap-[17px]">
        <div
          ...
          className={`flex justify-center items-center gap-2 ${(props.dateRange?.startDate || props.dateRange?.endDate) ? "bg-[#465fff] text-white": "bg-white text-[#4f4f4f]"} border border-1 border-[#e1e1e1] shadow-sm rounded-lg px-4 py-2 col-span-3 cursor-pointer`}>
        ...
        <div
          ...
          className={`flex justify-center items-center gap-2 ${props.selectedFilters.length > 0 ? "bg-[#465fff]": "bg-white text-[#4f4f4f]"} border border-1 border-[#e1e1e1] shadow-sm rounded-lg px-4 py-2 col-span-3 cursor-pointer`}>
          <LuSettings2
            size={18}
