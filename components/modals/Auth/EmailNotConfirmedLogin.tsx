      ...
      <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
        <div className="sm:flex justify-center">
          <div className="text-center sm:ml-4 sm:mt-4">
            ...
            <div className="mt-2">
              <Typography
                label="Your email is not verified yet. Please verify email to continue using your account. If you've forgotten your password, you can reset it and proceed to login"
                center
                variant="b3"
              />
            </div>
