  ...
  return (
    <>
            ...
            <div className="flex justify-center items-center">
              ...
              <Link className="pr-[35px]" href="/contact-us">
                <Typography
                  label="Contact Us"
                  variant="link"
                  bold={router.pathname === '/contact-us'}
                />
              </Link>
            </div>
          </>
        ...
        <div className="flex gap-[11px] justify-center items-center">
          ...
          {!userInfo && (
            <div className="flex gap-[23px]">
              <ButtonOld onClick={onSignup} label="Signup" variant="standard_sm" />
              <ButtonOld onClick={onLogin} label="Login" variant="standard_sm" filled />
            </div>
          )}
        </div>
      </div>
      ...
      <div className="lg:hidden flex flex-col w-full">
        <div className="flex items-center justify-between py-[16px] px-4 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
          {/* Left - Dashboard Button (only in dashboard routes) */}
          {(router.pathname === '/dashboard/job-status' ||
            router.pathname === '/dashboard/uploaded-files' ||
            router.pathname === '/account') && (
            <button
              onClick={handleToggle}
              className="flex items-center justify-center w-10 h-10 text-gray-500 rounded-lg dark:text-gray-400"
              aria-label="Toggle Sidebar"
            >
              {isMobileOpen ? (
                <svg
          ...
          <div className="flex-1 flex justify-center">
            <Link href="/home">
              <Image src={Logo} className="w-[140px] dark:invert" alt="Logo" priority />
            </Link>
          </div>
        ...
        {userInfo && (
          <div
            ...
            } bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 items-center justify-between gap-4 px-5 py-4`}
          >
