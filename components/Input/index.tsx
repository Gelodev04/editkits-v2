...
export default function Input(props: InputProps) {
  const baseClasses = `w-full font-lato font-normal text-sm border px-[21px] rounded-[8px] h-12 py-[14px] outline-none text-[#6f6c90] leading-[20px] shadow-[0_2px_4px_rgba(19,18,66,0.07)] dark:text-white`;
  // @ts-ignore
